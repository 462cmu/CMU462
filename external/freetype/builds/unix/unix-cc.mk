...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -arch x86_64 -DDARWIN_NO_CARBON -I/opt/local/include/harfbuzz  -DFT_CONFIG_OPTION_USE_HARFBUZZ -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS :=  -arch x86_64 -L/opt/local/lib -lharfbuzz 
